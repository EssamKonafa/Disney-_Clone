            ...
            <div className="flex">
                {movies.map((movie) => (
                    <div key={movie.id} className="flex-[0_0_100%] min-w-0 relative">
                        ...
                        <div className='hidden lg:inline absolute mt-0 top-0 pt-40 xl:pt-52 left-0 lg:mt-40 bg-transparent bg-gradient-to-r z-20 h-full w-full from-gray-900/90 via-transparent to-transparent p-10 space-y-5 text-white '>
